...
const DefectMapViewer = dynamic(
  () => import('@/components/thermographic/DefectMapViewer').then((mod) => ({ default: mod.DefectMapViewer })),
  {
    ssr: false,
    loading: () => (
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center p-6">
        <div className="bg-gray-800 rounded-lg p-6 text-center space-y-4">
          ...
          <Link href="/thermographic/projects" className="text-blue-400 hover:underline">
